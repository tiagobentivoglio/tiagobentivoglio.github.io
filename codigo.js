const padrao_silabas = new RegExp('(?:ch|nh|lh|gu|qu|ss|ps|^cu(?=i(?!m))|^mu(?=i)|[mnzskjhx]|[fpbvtdcçrg][lr]?|[lr])?(?:[ieaoíéêáâãóõôu][iu](?![iuz])[iu]?|[u(i)]|[áãâ][eo]|[õó][e]|[ieaouíéêáâãóõôúü])(?:(?:(?:(?:n(?!h)|d(?![rl])|m|c(?![rl])|t(?![lr])|z|x|p(?![slr])|b(?![rl])|g[?!rl])s?(?![ieaouíéêáâãóõôúü]))|(?:(?:i$)(?![ieaouíéêáãâóõôúüs]))|(?:(?:s)(?![ieaouíéêáãâóõôúüs]))|(?:(?:l)(?![hieaouíéêáãâóõôúü]))|(?:(?:g)(?![hieaouíéêáãâóõôúü]))|(?:(?:r)(?![rieaouíéêáâãóõôúü]))|(?:(?:f)(?![rieaouíéêáâãóõôúü]))))?', 'g');
